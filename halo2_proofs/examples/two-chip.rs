...
trait FieldInstructions<F: FieldFr>: AddInstructions<F> + MulInstructions<F> {
...
trait AddInstructions<F: FieldFr>: Chip<F> {
    /// Variable representing a number.
    type Num;
...
trait MulInstructions<F: FieldFr>: Chip<F> {
    /// Variable representing a number.
    type Num;
...
impl<F: FieldFr> AddInstructions<F> for FieldChip<F> {
    type Num = Number<F>;
    fn add(
        &self,
        layouter: impl Layouter<F>,
...
impl<F: FieldFr> AddInstructions<F> for AddChip<F> {
    type Num = Number<F>;
...
impl<F: FieldFr> Chip<F> for MulChip<F> {
...
impl<F: FieldFr> MulInstructions<F> for FieldChip<F> {
    type Num = Number<F>;
    fn mul(
        &self,
        layouter: impl Layouter<F>,
...
impl<F: FieldFr> MulInstructions<F> for MulChip<F> {
    type Num = Number<F>;
...
impl<F: FieldFr> FieldInstructions<F> for FieldChip<F> {
    type Num = Number<F>;
